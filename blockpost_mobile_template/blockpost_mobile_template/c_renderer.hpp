...
public:
	...
	il2cpp_array<c_material*>* get_materials( )
	{
		return reinterpret_cast< il2cpp_array<c_material*>* ( * )( c_renderer* ) >( il2cpp::resolve_icall( "UnityEngine.Renderer::GetMaterialArray" ) )( this );
	}	
	void set_materials( il2cpp_array<c_material*>* mats )
	{
		reinterpret_cast< void ( * )( c_renderer*, il2cpp_array<c_material*>* ) >( il2cpp::resolve_icall( "UnityEngine.Renderer::SetMaterialArray" ) )( this, mats );
	}
